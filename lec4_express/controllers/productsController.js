...
export function validateCreateProductBody(req, res, next){
    let body = req.body;
    let error = productBodySchema.productSchema.validate(body).error;
...
export function validateUpdateProductBody(req, res, next){
    let body = req.body;
    let error = productBodySchema.productUpdateSchema.validate(body).error;
